import 'dart:convert';
import 'package:ark_module_regular/src/domain/entities/course_category_entity.dart';
...
import 'package:ark_module_regular/src/domain/entities/lowongan_entity.dart';
...
class CourseDataEntity extends Equatable {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "mp_links": List<dynamic>.from(mpLinks.map((e) => e.toJson())),
